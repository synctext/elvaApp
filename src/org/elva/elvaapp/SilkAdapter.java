...
public abstract class SilkAdapter<ItemType extends SilkComparable> extends BaseAdapter implements ScrollStatePersister {
    ...
    /**
     * @deprecated Override {@link #onViewCreated(int, android.view.View, org.elva.elvaapp.SilkComparable)} instead.
     */
    @Override
    ...
    /**
     * Gets the scroll state set by a {@link org.elva.elvaapp.SilkListView}.
     */
    @Override
    ...
    /**
     * Used by the {@link org.elva.elvaapp.SilkListView} to update the adapter with its scroll state.
     */
    @Override
